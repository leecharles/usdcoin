...
uint256 hashGenesisBlock("0x000006febd296fc0d7d22c46688d70babf3fcec34b7af0c585a40e5d5ba045ee");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // UsdCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "UsdCoin Signed Message:\n";
...
{
    // UsdCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // UsdCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "usdc genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //assert(block.hashMerkleRoot == uint256("0xb8019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a"));
...
unsigned char pchMessageStart[4] = { 0xf5, 0xc7, 0xb9, 0xde }; // UsdCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UsdCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UsdCoinMiner : ProcessBlock, block not accepted");
    }
